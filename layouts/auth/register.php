...
<div class="modal fade" id="myModal2" role="dialog">
        ...
        <div class="modal-body" style="padding:10px 15px;">
          <form method="post" class="form-horizontal" >
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input id="sid" type="text" class="form-control" name="sid" placeholder="Enter EWU Student ID eg. 2013-2-60-009" required/> &nbsp;*
              </div>
            </div>
  ...
  <script>
    ...
    function validation(){
      ...
      var emailPattern = /^([0-9])-([0-9])-([0-9])-([0-9])$/;
//      var namePattern = /^[a-zA-Z ].*$/;
      var msg ;
      if(!sidPattern.test(sid) && sid.length!=0 && sid.length == 13){
      ...
      {
        //alert("Username can\'t excede 10 characters");
